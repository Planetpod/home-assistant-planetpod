                ...
                "cards": [
                    {
                        ...
                        "header": {"show": True, "title": "SoC (%)", "show_states": False},
                        "graph_span": "24h",
                        "yaxis": [{"min": 0, "max": 100}],
                        "series": [
                            {"entity": soc, "name": "SoC", "color": "#5551fe", "type": "area", "stroke_width": 2},
                            {
                                "entity": upper,
                                "name": "Upper limit",
                                "color": "#88888880",
                    ...
                    {
                        "type": "custom:apexcharts-card",
                        "header": {"show": True, "title": "Energy Usage", "show_states": False},
                        "graph_span": "24h",
                        "chart_type": "bar",
                        "series": [
                            {
                                "entity": grid_delivered,
                                "name": "Grid import",
                                "color": "#f8333c",
                                "type": "column",
