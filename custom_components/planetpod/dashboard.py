        ...
        "sections": [
            ...
            },
            {
                ...
                "cards": [
                    {"type": "heading", "heading": "Charts", "icon": "mdi:chart-line"},
                    {
                        ...
                        "grid_options": {"columns": 16, "rows": 8},
                    },
                    {
            ...
            },
            {
                ...
                "cards": [
                    ...
                    {"type": "entities", "entities": entity_col_1, "grid_options": {"columns": 8, "rows": 6}},
                    {"type": "entities", "entities": entity_col_2, "grid_options": {"columns": 8, "rows": 6}},
                    {"type": "entities", "entities": entity_col_3, "grid_options": {"columns": 8, "rows": 6}},
                    {
                        "type": "grid",
                        "columns": 1,
                    ...
                    },
                    {
                        ...
                        "grid_options": {"columns": 16, "rows": 6},
                    },
                ],
            },
        ],
